...
export const metadata: Metadata = {
  ...
  description: 'Convert videos to MP4 format with customizable quality settings and bitrate options.',
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-6">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Convert videos to MP4 format with customizable quality settings and bitrate options.
            </p>
          </div>
