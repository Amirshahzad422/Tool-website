...
export const metadata: Metadata = {
  ...
  description: "Convert between different units of length, weight, temperature, area, volume, speed, and pressure. Fast, accurate, and easy-to-use unit conversion tool.",
